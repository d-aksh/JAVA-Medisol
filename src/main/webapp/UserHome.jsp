...
<body>
  ...
  <header class="container bg-info mt-4">
  	<div class="p-2">
  ...
  <header class="container bg-primary text-white mt-4">
  	<h4>Upload your Prescription:</h4>
  	<div class="p-2">
        <form action="UploadPrescription" method="post" enctype="multipart/form-data" >
          <div class="form-row">
		    <div class="col-10">
		      <input class="form-control" type="file" accept=".jpg,.jpeg,.png" name="image" required/>
		    </div>
		    <div class="col-2">
